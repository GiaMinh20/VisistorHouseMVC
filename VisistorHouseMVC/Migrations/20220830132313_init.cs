        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PictureUrl = table.Column<List<string>>(type: "text[]", nullable: true),
                    PublicId = table.Column<List<string>>(type: "text[]", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductAddress_Products_Id",
                        column: x => x.Id,
            ...
            migrationBuilder.CreateTable(
                name: "ProductSavedNews",
                columns: table => new
                {
                    ProductsId = table.Column<string>(type: "text", nullable: false),
                    SavedNewsId = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductSavedNews", x => new { x.ProductsId, x.SavedNewsId });
                    table.ForeignKey(
                        name: "FK_ProductSavedNews_Products_ProductsId",
                        column: x => x.ProductsId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductSavedNews_SavedNews_SavedNewsId",
                        column: x => x.SavedNewsId,
                        principalTable: "SavedNews",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSavedNews_SavedNewsId",
                table: "ProductSavedNews",
                column: "SavedNewsId");
